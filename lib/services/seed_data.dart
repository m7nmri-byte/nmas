...
/// تاريخ بداية المخيم (اليوم الأول). يمكن تعديله لاحقاً في أي وقت من
/// لوحة التحكم (قسم الإعدادات) دون الحاجة لإعادة استيراد البيانات.
final DateTime kDefaultCampStartDate = DateTime(2026, 8, 17);
